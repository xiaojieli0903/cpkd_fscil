...
class ETFHead(ClsHead):
    ...
    def __init__(self, num_classes: int, in_channels: int, *args,
        ...
        self.use_etf = kwargs.pop('use_etf', True)
        self.num_fake_classes = kwargs.pop('num_fake_classes', 0)
        self.trainable = kwargs.pop('trainable', False)
        self.prototype_classifier = None
        ...
        self.num_classes -= self.num_fake_classes
        self.eval_classes -= self.num_fake_classes
    ...
    def simple_test(self,
        ...
        if post_process:
            if not return_others:
                ...
                return self.post_process(cls_score), outputs
        else:
            if not return_others:
                return cls_score
            else:
                return cls_score, outputs
